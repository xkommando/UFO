...
void __ufo_ptr_prop(void* addr_src, void* addr_dest) {
  bw::ufo::on_ptr_prop(cur_thread(), CALLERPC, (uptr)addr_src, (uptr)addr_dest);
}
void __ufo_ptr_deref(void* addr_ptr) {
  bw::ufo::on_ptr_deref(cur_thread(), CALLERPC, (uptr)addr_ptr);
}
